            ...
            onPressed: () {
              ...
              setState(() {
                if (this.cusIcon.icon == Icons.search) {
                  ...
                  this.cusSearchBar = Text("Societies");
                }
              });
            },
          )
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              addEvent("  Divinity\n  Society",
                                  "https://www.duupdates.in/wp-content/uploads/2020/10/Mata-Sundari-College-for-Women.jpg"),
                              SizedBox(
                                width: 10.0,
                              ),
                              addEvent("   Cultural\n   Society",
                              ...
                              addEvent("  Parindey",
                                  "https://www.mscw.ac.in/resources/img/gallery/Annual_day/an4.JPG"),
                              SizedBox(
                                width: 10.0,
                              ),
                              addEvent("  Pratibimb",
                                  "https://www.mscw.ac.in/resources/img/gallery/Annual_day/an1.JPG"),
                            ],
                          ),
                        ),
                        Padding(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          launch("https://www.mscw.ac.in/Annual_Reports.aspx");
        },
        child: Container(
          height: 170,
          width: 130,
