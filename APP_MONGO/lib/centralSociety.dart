...
class centralSociety extends StatefulWidget {
  @override
  centralSocietyState createState() => centralSocietyState();
}

class centralSocietyState extends State<centralSociety> {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "Uddham, The Entrepreneurship Cell of Mata Sundri College for Women was formed in January 2021 by Internal Quality Assurance Cell (IQAC) in collaboration with the Department of Commerce.",
          ...
          InkWell(
                ...
                children: <Widget>[
                  Container(
                    child: Align(
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(20, 10, 0, 0),
                        child: Text("Placement and Internship Cell",
                            style: GoogleFonts.roboto(
                                textStyle: TextStyle(
                              fontSize: 25,
                              fontWeight: FontWeight.bold,
                  ...
                  Container(
                    child: Text(
                        "You can use this trick. Text Just wrap a text around three single quotes and flutter will format a text as per its length . No need to use max lines and text field.",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
            ...
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Society1()));
            },
          ),
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(
                      "https://media-exp1.licdn.com/dms/image/C560BAQHyLbEngmbVIw/company-logo_200_200/0/1596546180778?e=2159024400&v=beta&t=ZBUW9aSGDzgNCpqX2H-O0CKiKJOW81gKnMqM3EZt3Zg"),
                  fit: BoxFit.cover,
                  colorFilter: ColorFilter.mode(
                      Colors.black.withOpacity(0.7), BlendMode.darken),
                ),
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://mscw.ac.in/resources/img/NorthEast.jpg"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "North East Welfare Cell has been established in the college. With the rise of racial abuse against the people from North East region, the North East Welfare Cell ensures that any kind of discrimination and harassment is prevented.",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "The college has an Equal Opportunity Cell (EOC) in accordance with the UGC Guidelines for Scheme of Equal Opportunity centre for colleges. It is fully functional body to ensure that all students and employees are treated as equal and attempts to address deep-seated inequalities in our system.",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://mscw.ac.in/images/divinity/guru.JPG"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "The Divinity Society is integral to the dissemination of the ideals which form the foundation of this institution. It imparts the message of humanity, love, truth, honesty and courage to our students and staff. ",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://mscw.ac.in/resources/img/cul1.JPG"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "Mata Sundri College has a vibrant cultural life. The college has a Cultural Society which promotes a variety of western, folk and classical dances. It is one of the most active societies of the College. ",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "The college has a very active Dramatics society ‘PARINDEY’. The Dramatic society of the college organizes cultural shows and street plays on socially relevant themes. This gives the students a platform to showcase their talents. ",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image:
                        NetworkImage("https://mscw.ac.in/Societies/quiz.jpg"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "Quizz Up society holds a GK test, annually. The test comprises two rounds. The first round consists of multiple choice questions and the students who clear this test qualify for the second round Two students with the highest score represent the college in various inter college quiz competitions.",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://www.mscw.ac.in/resources/img/debating_society.jpg"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "Oratory skills, Logical reasoning and factual Knowledge are the fundamental leadership qualities. The Debating Society of the College provides a forum through which students can hone their oratory and analytical skills while learning to work as a team.",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://mscw.ac.in/resources/img/ncc.png"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://mscw.ac.in/resources/img/NSS/nss203.jpg"),
                    fit: BoxFit.cover,
                    colorFilter: ColorFilter.mode(
                        Colors.black.withOpacity(0.7), BlendMode.darken),
                  )),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                        "The College has an active wing of National Service Scheme.lt provides ample opportunities for students to serve society and also helps in their personal development .The motto of N.S.S. is “Not me but you” an important principle in inculcating a sense of social and civic responsibility among students.",
                        style: GoogleFonts.lato(
                            textStyle: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
          ...
          SingleChildScrollView(
              ...
              child: Row(
                  ...
                  children: <Widget>[
                    addEvent(
                        "https://pbs.twimg.com/media/ERnWaDhVUAAU4r2?format=jpg&name=large"),
                    addEvent("https://mscw.ac.in/resources/img/NorthEast.jpg"),
                    addEvent("https://mscw.ac.in/resources/img/NorthEast.jpg"),
                    addEvent(
                        "https://mscw.ac.in/resources/img/slider/alumnii1.jpg"),
                    addEvent("https://mscw.ac.in/resources/img/NorthEast.jpg"),
                    addEvent(
                        "https://www.mscw.ac.in/resources/img/event/comm/ev23.jpg"),
                  ]))
        ]))));
  }
}
